...
setIsPasswordMatching(false)
    ...
    return shouldShow && <>
      ...
      {changingPassword?<div className="z-20 relative overflow-hidden top-48 left-2 md:left-2  bg-white rounded-lg w-[360px] lg:left-1 popup-animation">
    <p className=" text-xl font-bold p-4 font-mono rounded-lg  ">
