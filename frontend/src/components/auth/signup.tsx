...
export default function Signup() {
   ...
   const isSignupClicked= useSelector<Store>(state=>state.auth.isSignupClicked) as boolean
    ...
    return    (isFormVisible && isSignupClicked)&&  <><div className="fixed   bg-[rgba(0,0,0,0.4)] top-0 left-0 z-10 w-[100%] h-[100%]  " onClick={()=>{  dispatch(setIsSignupClicked(!isSignupClicked))
